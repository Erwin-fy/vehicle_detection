...
class SSDNet(object):
    """Implementation of the SSD VGG-based 500*250 network.

    The default features layers with 500x250 image input are:
      conv4 ==> 38 x 38
      conv7 ==> 19 x 19
      conv8 ==> 10 x 10
      conv9 ==> 5 x 5
    ...
    default_params = SSDParams(
        ...
        feat_shapes=[(32, 63), (16, 32), (8, 16), (4, 8), (2, 4), (1, 1)],
        #feat_shapes=[(38, 38), (19, 19), (10, 10), (5, 5), (3, 3), (1, 1)],
        anchor_size_bounds=[0.15, 0.90],
        #anchor_size_bounds=[0.20, 0.90],
        anchor_sizes=[(18.75, 37.5),
                      (37.5, 82.5),
                      (82.5, 127.5),
                      (127.5, 172.5),
                      (172.5, 217.5),
                      (217.5, 262.5)],
        #anchor_sizes=[(25.0, 50.0),
        #               (50., 92.5),
        #               (92.5, 135.),
        #               (135., 177.5),
        #               (177.5, 220.),
        ...
        anchor_ratios=[[2, .5],
                       ...
                       [2, .5],
                       [2, .5]],
        anchor_steps=[8, 16, 32, 64, 125, 250],
        anchor_offset=0.5,
...
def ssd_net(inputs,
    ...
    end_points = {}
    with tf.variable_scope(scope, 'ssd_500_250_vgg', [inputs], reuse=reuse):
        ...
        with tf.variable_scope(end_point):
            ...
            print net.op.name, net.get_shape().as_list()
            '''
            net = slim.avg_pool2d(net, [2, 4], stride=1, padding='VALID')
            print net.op.name, net.get_shape().as_list()
        end_points[end_point] = net
...
ssd_net.default_image_size = 250
