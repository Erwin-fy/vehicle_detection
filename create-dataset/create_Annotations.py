...
_INDENT = ' ' * 4
_NEW_LINE = '\n'
_FOLDER_NODE = 'CARS2017'
_ROOT_NODE = 'annotation'
_DATABASE_NAME = 'CARS2017 DATABASE'
_CLASS = 'car'
_ANNOTATION = 'CARS2017'
_AUTHOR = 'Peic'
...
_IMAGE_PATH = '/media/SecondDisk/CARS2017/test/JPEGImages/'
_TXT_PATH = '/media/SecondDisk/CARS2017/test/Annotations_txt/'
...
# 创建XML文档并写入节点信息
def createXMLFile(attrs, width, height, depth, filename):
    ...
    createChildNode(doc, 'depth', str(depth), size_node)
...
def parse(filename):
    ouput_file = open(_TXT_PATH +  filename[0: len(filename)-4] + '.txt')
    ...
    for line in lines:
        ...
        if os.path.exists( xml_file_name):
            ...
            # 创建XML文件
            createXMLFile(attrs, width, height, depth, xml_file_name)

def main():
    for root, dirnames, filenames in os.walk(_IMAGE_PATH):
