...
from datasets import cars_to_tfrecords
...
def main(_):
    ...
    if FLAGS.dataset_name == 'pascalvoc':
        pascalvoc_to_tfrecords.run(FLAGS.dataset_diri ,FLAGS.output_dir, FLAGS.output_name, FLAGS.shuffling)
    elif FLAGS.dataset_name == 'cars':
        cars_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name, FLAGS.shuffling)
    else:
